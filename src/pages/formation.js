                ...
                <div className="box formation-info-box m-6">
                    <div className="columns">
                        ...
                        <div className="column is-narrow">
                            ...
                            <div className="columns is-mobile">
                                <div className="column is-narrow">
                                    <p className="is-size-5 has-text-dark">Durée:</p>
                                </div>
                                <div className="column is-narrow pl-0">
                                    <p className="is-size-5 has-text-dark">{formationData.formation.duration ? formationData.formation.duration : ""} heures</p>
                                </div>
                            </div>
                            <div className="columns is-mobile">
                                <div className="column pt-0 is-narrow">
                                    <p className="is-size-5 has-text-dark">Date:</p>
                                </div>
                                <div className="column pt-0 is-narrow pl-0">
                                    <p className="is-size-5 has-text-dark">{formationData.formation.date ? formationData.formation.date : ""}</p>
                                </div>
                            </div>
                            <div className="columns is-mobile">
                                <div className="column pt-0 is-narrow">
                                    <p className="is-size-5 has-text-dark">Prix:</p>
                                </div>
                                <div className="column pt-0 is-narrow pl-0">
                                    <p className="is-size-5 has-text-dark">{formationData.formation.price ? formationData.formation.price : ""} TND</p>
                                </div>
                            </div>
                            <div className="columns is-mobile">
                                <div className="column pt-0 is-narrow">
                    ...
                    <div className="field">
                        ...
                        <div className="control">
                            <div className="select">
                                <select onChange={(event) => setScore(event.target.value)} required>
            ...
            <div className="comment-section">
                {
                    ...
                    <div>
                            ...
                            <div className="comments-container">
                                {
                                    ...
                                    {
                                        return(
                                            <div key={comment._id} className="box m-3 mb-5">
                                                ...
                                                <p className="has-text-warning lvl-7 mt-0 pt-0">{"★".repeat(comment.score)}</p>
                                                <p className="subtitle is-5 has-text-dark mt-2">{comment.comment}</p>
                                            </div>
                                        )
                                    })
                                }
                        ...
                        <div className={formationData.formation.comments.length === 0 ? "comments" : "is-hidden"}>
                            <p className="title has-text-dark has-text-centered orange-text">Commentaires</p>
                            <div className="comments-container">
                                <p className="title has-text-dark has-text-centered">Il n'y a pas encore de commentaires</p>
                            </div>
                        </div>
                    </div>
                    :
